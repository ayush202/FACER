 ...
 * @author ayush
 */
public class Usb_cam_implement implements Runnable {
    ...
    public Usb_cam_implement(train obj, int x, boolean t, String s) {
        panel = obj.panel;
    ...
    public void run() {
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder(home.path_to_python + "/venv/bin/python3",
                    ...
                    + "/demos/dataset_create.py", "--captureDevice", "1", "--width",
            ...
            while (!client.isClosed()) {
                ...
                if (fromClient.equals("directory created")) {
                    file = new File(home.path_to_python + "/openface-master/aligned-images/"
                            + assign + "/index.txt");
                    file.createNewFile();
            ...
            pb = new ProcessBuilder(home.path_to_python + "/venv/bin/python3",
                    home.path_to_python + "/data_augment.py",
                    home.path_to_python + "/openface-master/aligned-images/" + assign, "outerEyesAndNose");
